...
/* Swipe from the left edge to go back.
   ...
   This exists because of the founding decision to be a PWA. Installed to the
   ...
   simply is not there, and the only way out of a screen is a 44px target in
   the far top-left, which is the hardest place on a phone to reach.

   It does exactly what the visible Back arrow does, and goes to the same
   place. A gesture that does something the screen does not also offer is a
...
export default function SwipeBack({ to }: { to: string }) {
